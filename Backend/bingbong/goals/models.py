...
class Goal(models.Model):
  ...
  soju_goal = models.IntegerField(default=0)
  beer_goal = models.IntegerField(default=0)
  mak_goal = models.IntegerField(default=0)
  wine_goal = models.IntegerField(default=0)
